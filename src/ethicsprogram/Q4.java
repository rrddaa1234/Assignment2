...
public class Q4 extends javax.swing.JFrame {
    ...
    public Q4() {
        initComponents();
            ...
            public void windowActivated(WindowEvent e) {
                ...
                jLabel1.setText("Case #4: "+MainMenu.c[3].getCaseTitle());
                jLabel2.setText(MainMenu.c[3].getCategory());
                jTextArea2.setText(MainMenu.c[3].getCaseDescription());
                if (MainMenu.c[3].verdict.getStudentVerdict().equals("Ethical")) {
                    jRadioButton1.setSelected(true);  //This so if the user goes back to a page, it remembers what they put
                }
                else if (MainMenu.c[3].verdict.getStudentVerdict().equals("Unethical")) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        MainMenu.c[3].verdict.setReason(jTextArea2.getText());
